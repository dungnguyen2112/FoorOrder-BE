...
public class UserDetailsCustom implements UserDetailsService {
    ...
    // get Current User
    public com.example.cosmeticsshop.domain.User getCurrentUser() {
        Optional<String> currentUser = securityUtil.getCurrentUserLogin();
        com.example.cosmeticsshop.domain.User user = userService.handleGetUserByUsernameOrEmail(currentUser.get());
        if (user == null) {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        com.example.cosmeticsshop.domain.User user = userService.handleGetUserByUsernameOrEmail(username);
        if (user == null) {
